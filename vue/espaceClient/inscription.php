...
<section id="conteneur">
    <article id="inscription">
        ...
        <form method="post" action=<?php if ($utilisateurSecondaire == False) {echo "/espace-client/inscription-control";} else if ($utilisateurSecondaire == True) {echo "/espace-client/modifier-donnees-perso/ajouter-un-utilisateur-control";}?>>
            <?php if ($utilisateurSecondaire == False){ ?><div><label for="nom">Nom</label><input type="text" name="nom" id="nom" <?= isset($_POST['nom']) ? $_POST['nom'] : ""; ?>></div><?php } ?>
            ...
            <?php if ($utilisateurSecondaire == False){ ?><div><label for="numero">Numero de telephone</label><input type="text" name="numero" id="numero"<?= isset($_POST['numero']) ? $_POST['numero'] : ""; ?>></div><?php }?>
