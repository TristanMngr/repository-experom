...
<section id="mode">
    ...
    <div>
        ...
        <ul>
            <li>
                <h3>Temperature</h3><label for="presentTemp">Lorsque tu es présent</label><input type="text" name="presentTemp" id="presentTemp" class="inputMode" value="24">
    ...
    <div>
        ...
        <ul>
            <li>
                <h3>Temperature</h3><label for="absentTemp">Lorsque tu es absent</label><input type="text" id="absentTemp" class="inputMode" value="19">
                <input type="submit" value="Valider">
            </li>
            <li>
                <h3>Lumiere</h3>
